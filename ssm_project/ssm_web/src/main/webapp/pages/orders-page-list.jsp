...
<body class="hold-transition skin-purple sidebar-mini">
			...
			<section class="content">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<!-- 数据表格 -->
						<div class="table-box">
							<form action="${pageContext.request.contextPath}/orders/delete.do"
								  method="post">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button id="btdelete" type="submit" class="btn btn-default" title="删除">
	...
	<script>
		...
		// 	$("#dataList td input[type=checkbox]:checked").each(function(){
