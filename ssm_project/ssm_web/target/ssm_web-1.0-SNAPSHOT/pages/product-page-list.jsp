			...
			<section class="content">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<!-- 数据表格 -->
						<div class="table-box">
							<form action="${pageContext.request.contextPath}/product/delete.do"
								  method="post">
								<input name="ids" value="#" hidden/>
									...
									<c:forEach items="${pageInfo.list}" var="product">
										...
										<tr>
											...
											<td class="text-center">
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/findByProductId.do?pid=${product.id}'">订单</button>
