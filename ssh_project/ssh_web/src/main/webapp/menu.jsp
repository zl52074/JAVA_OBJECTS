							...
							<TBODY>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_6');"><SPAN
										class=span id=table_6Span>＋</SPAN> 用户管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_6 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
											<TR>
												<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/user_add.action" target=main>－新增用户</A></TD>
											</TR>
											<TR>
												<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/user_userList.action" target=main>－用户列表</A></TD>
											</TR>
											</TBODY>
										</TABLE>
									</TD>
