					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3">
									<s:select list="list" name="customer.cust_id" headerKey=""  cssStyle="WIDTH: 180px;HEIGHT:19px" headerValue="-请选择-" listKey="cust_id" listValue="cust_name"/>
								</td>
							</tr>
							<TR>
								<td>联系人名称：</td>
							...
							<TR>
								...
								<td>联系人备注 ：</td>
								<td>
								<s:textarea name="lkm_memo" rows="2" cssStyle="WIDTH: 176px" cols="20"></s:textarea>
								</td>
							</TR>
							<tr>
								<td rowspan=2>
