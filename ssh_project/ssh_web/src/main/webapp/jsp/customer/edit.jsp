					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>客户级别 ：</td>
								<td>
									<select id="cust_level" name="baseDictLevel.dict_id" style="WIDTH: 182px;height: 19px">
							...
							<TR>
								...
								<td>信息来源 ：</td>
								<td>
									<select id="cust_source" name="baseDictSource.dict_id" style="WIDTH: 182px;height: 19px">
										<option value="">-请选择-</option>
									</select>
								</td>
								<td>所属行业 ：</td>
								<td>
									<select id="cust_industry" name="baseDictIndustry.dict_id" style="WIDTH: 182px;height: 19px">
										<option value="">-请选择-</option>
									</select>
								</td>
							</TR>
