...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/user_userList.action"
		method=post>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>用户名称：</TD>
													<TD>
													<s:textfield theme="simple" name="user_name" cssClass="textbox" cssStyle="WIDTH: 80px"  maxlength="50" />
													</TD>
													<TD>用户状态：</TD>
													<TD>
											...
											<TBODY>
												...
												<TR
													...
													<TD>
														...
														<s:elseif test='user_state == "0"'>
															暂停
														</s:elseif>
													</TD>
													
													<TD>
													<a href="${pageContext.request.contextPath }/user_delete.action?user_id=<s:property value="user_id"/>">删除</a>
													</TD>
												</TR>
