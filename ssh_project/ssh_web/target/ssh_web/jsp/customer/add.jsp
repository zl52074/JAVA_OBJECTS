					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>客户级别 ：</td>
								<td>
									<select id="cust_level" style="WIDTH: 182px;height: 19px" name="baseDictLevel.dict_id">
							...
							<TR>
								...
								<td>信息来源 ：</td>
								<td>
									<select id="cust_source" style="WIDTH: 182px;height: 19px" name="baseDictSource.dict_id">
										<option value="">-请选择-</option>
									</select>
								</td>
								<td>所属行业 ：</td>
								<td>
									<select id="cust_industry" style="WIDTH: 182px;height: 19px" name="baseDictIndustry.dict_id">
										<option value="">-请选择-</option>
									</select>
								</td>
							</TR>
