				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：客户拜访记录管理 &gt; 编辑客户拜访记录</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>拜访客户：</td>
								<td>
									<s:select list="clist" name="customer.cust_id" headerKey=""  cssStyle="WIDTH: 180px;HEIGHT:19px" headerValue="-请选择-" listKey="cust_id" listValue="cust_name"/>
								</td>
								<td>业务员名称：</td>
								<td>
									<s:select list="ulist" name="user.user_id" headerKey=""  cssStyle="WIDTH: 180px;HEIGHT:19px" headerValue="-请选择-" listKey="user_id" listValue="user_name"/>
								</td>
							</tr>
							<TR>
